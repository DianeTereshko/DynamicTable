...
function DrowTable(head, data) {
    var theader = "<thead scope=\"col\"><tr class=\"w3-red\"><th id=\"head-name\"class=\"w3-ext-cursor\"><p>" + head[0] + "<i class=\"material-icons w3-ext-sort-icon\">unfold_more</i></p></th><th class=\"w3-ext-cursor\"><p>" + head[1] + "<i class=\"material-icons w3-ext-sort-icon\">unfold_more</i></p></th><th>" + head[2] + "</th><th>\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u044F</th></tr></thead>";
